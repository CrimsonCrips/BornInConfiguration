...
public class BIConfig {
    ...
    public static void bake() {
        try {
            ...
            PUMPKINHEAD_ARMOR = ConfigHolder.BORNCONFIG.PUMPKINHEAD_ARMOR.get();
            PUMPKINHEAD_DAMAGE = ConfigHolder.BORNCONFIG.PUMPKINHEAD_DAMAGE.get();
            PUMPKINHEAD_HEALTH = ConfigHolder.BORNCONFIG.PUMPKINHEAD_HEALTH.get();
            PUMPKINHEAD_KNOCKBACK = ConfigHolder.BORNCONFIG.PUMPKINHEAD_KNOCKBACK.get();
            PUMPKINHEAD_KNOCKBACK_RESISTANCE = ConfigHolder.BORNCONFIG.PUMPKINHEAD_KNOCKBACK_RESISTANCE.get();
            PUMPKINHEAD_SPEED = ConfigHolder.BORNCONFIG.PUMPKINHEAD_SPEED.get();

            SIAMESE_SKELETONS_ARMOR = ConfigHolder.BORNCONFIG.SIAMESE_SKELETONS_ARMOR.get();
            SIAMESE_SKELETONS_DAMAGE = ConfigHolder.BORNCONFIG.SIAMESE_SKELETONS_DAMAGE.get();
            SIAMESE_SKELETONS_HEALTH = ConfigHolder.BORNCONFIG.SIAMESE_SKELETONS_HEALTH.get();
            SIAMESE_SKELETONS_KNOCKBACK = ConfigHolder.BORNCONFIG.SIAMESE_SKELETONS_KNOCKBACK.get();
            SIAMESE_SKELETONS_SPEED = ConfigHolder.BORNCONFIG.SIAMESE_SKELETONS_SPEED.get();

            SPIRIT_ASSISTANT_ARMOR = ConfigHolder.BORNCONFIG.SPIRIT_ASSISTANT_ARMOR.get();
            SPIRIT_ASSISTANT_DAMAGE = ConfigHolder.BORNCONFIG.SPIRIT_ASSISTANT_DAMAGE.get();
            SPIRIT_ASSISTANT_HEALTH = ConfigHolder.BORNCONFIG.SPIRIT_ASSISTANT_HEALTH.get();
            SPIRIT_ASSISTANT_KNOCKBACK = ConfigHolder.BORNCONFIG.SPIRIT_ASSISTANT_KNOCKBACK.get();
            SPIRIT_ASSISTANT_SPEED = ConfigHolder.BORNCONFIG.SPIRIT_ASSISTANT_SPEED.get();
            ...
            FALLEN_CHAOS_KNIGHT_KNOCKBACK_RESISTANCE = ConfigHolder.BORNCONFIG.FALLEN_CHAOS_KNIGHT_KNOCKBACK_RESISTANCE.get();
            ...
            SIR_PUMPKIN_HEAD_ARMOR = ConfigHolder.BORNCONFIG.SIR_PUMPKIN_HEAD_ARMOR.get();
            SIR_PUMPKIN_HEAD_DAMAGE = ConfigHolder.BORNCONFIG.SIR_PUMPKIN_HEAD_DAMAGE.get();
            SIR_PUMPKIN_HEAD_HEALTH = ConfigHolder.BORNCONFIG.SIR_PUMPKIN_HEAD_HEALTH.get();
            SIR_PUMPKIN_HEAD_KNOCKBACK = ConfigHolder.BORNCONFIG.SIR_PUMPKIN_HEAD_KNOCKBACK.get();
            SIR_PUMPKIN_HEAD_KNOCKBACK_RESISTANCE = ConfigHolder.BORNCONFIG.SIR_PUMPKIN_HEAD_KNOCKBACK_RESISTANCE.get();
            SIR_PUMPKIN_HEAD_SPAWNING_ENABLED = ConfigHolder.BORNCONFIG.SIR_PUMPKIN_HEAD_SPAWNING_ENABLED.get();
            SIR_PUMPKIN_HEAD_SPEED = ConfigHolder.BORNCONFIG.SIR_PUMPKIN_HEAD_SPEED.get();
